// Screening questionnaire — verbatim question text and 1–5 anchor labels.
// IMPORTANT: This file MUST stay in sync with `server/screening-questions.js`.
// See `docs/11-screening.md` for the polarity caveat (some scales are negatively
// worded, others positively) and how raw averages should be interpreted.
