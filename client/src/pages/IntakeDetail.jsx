      ...
      <div style={{ display: 'grid', gap: '0.75rem', marginTop: '0.75rem' }}>
        ...
        <section className="card">
          ...
          {intake.summary ? (
            ...
            <p style={{ color: '#999', fontStyle: 'italic' }}>
              Summary is still being generated or was unavailable. Review the transcript below.
            </p>
          )}
        ...
        <section className="card">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem 1.5rem' }}>
            <Field label="Name" value={intake.clientName} />
            <Field label="Contact Preference" value={intake.contactPreference} />
            <Field label="Need Category" value={intake.needCategory} />
            <Field label="Urgency" value={intake.urgencyFlag} />
